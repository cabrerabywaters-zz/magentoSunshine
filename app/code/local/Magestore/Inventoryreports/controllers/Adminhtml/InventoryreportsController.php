...
class Magestore_Inventoryreports_Adminhtml_InventoryreportsController extends Mage_Adminhtml_Controller_Action
{
    ...
    /**
     * Show list of purchase order action
     */
    ...
    /**
     * Render grid of purchase orders
     */
     ...
     */
    public function exportPurchaseOrderCsvAction() {
        $fileName   = 'inventoryreports_purchase_orders.csv';
        $content    = $this->getLayout()
                           ->createBlock('inventoryreports/adminhtml_list_purchaseorder_grid')
                           ->getCsv();

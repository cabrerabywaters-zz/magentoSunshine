...
class Magestore_Inventorylowstock_Model_Observer
{
    ...
    public function stockChange($observer)
    {
        ...
        if (in_array($stockItem->getProductTypeId(), array('configurable', 'bundle', 'grouped', 'virtual', 'downloadable'))) return;
        ...
        if (count($results) == 0 && $isInStock) return;
...
//set month        
    ...
    public function adminSessionUserLoginSuccess($observer)
    {
        ...
        try {
            ...
            throw new Exception(Mage::helper('inventorylowstock')->__('Unable to create notification log.'));
        }
    }
}

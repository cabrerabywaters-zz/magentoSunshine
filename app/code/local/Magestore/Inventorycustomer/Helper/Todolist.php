 ...
 */
class Magestore_Inventorycustomer_Helper_Todolist extends Mage_Core_Helper_Abstract {

    public function getTodolist() {
        $todolistCollection = Mage::getModel('inventorycustomer/customerinteraction')->getCollection();

        $todolistCollection = $this->joinEavTablesIntoCollection($todolistCollection, 'customer_id', 'customer');

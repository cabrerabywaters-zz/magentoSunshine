...
class Magestore_Inventoryphysicalstocktaking_Model_Observer {
    ...
    public function inventoryplus_inventory_stock_action_buttons($observer){
        ...
        $actions['physical_stocktaking'] = array('params' => array(
                    ...
                    'onclick' => 'location.href=\''.Mage::getSingleton('adminhtml/url')->getUrl('inventoryphysicalstocktakingadmin/adminhtml_physicalstocktaking/new').'\'',
                    'class' => 'save',
                        ),
                    'position' => -90
            );
    ...
    public function inventoryplus_warehouse_stock_action_buttons($observer){
        ...
        $actions['physical_stocktaking'] = array('params' => array(
                    'label' => Mage::helper('inventoryphysicalstocktaking')->__('Physical Stock-taking'),
                    'onclick' => 'location.href=\''.Mage::getSingleton('adminhtml/url')->getUrl('inventoryphysicalstocktakingadmin/adminhtml_physicalstocktaking/prepare',array('warehouse_id'=>$warehouse->getId())).'\'',
                    'class' => 'save',
                        ),
                    'position' => -90
            );

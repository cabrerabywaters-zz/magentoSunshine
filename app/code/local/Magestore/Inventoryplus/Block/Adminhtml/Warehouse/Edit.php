    ...
    public function __construct() {
        ...
        if(Mage::helper('inventoryplus/warehouse')->isAllowAction('adjust', $warehouse)){
            $stockActions['adjust_stock'] = array('params' => array(
                    ...
                    'onclick' => 'location.href=\''. $this->getUrl('*/adminhtml_adjuststock/prepare', array('warehouse_id'=>$warehouseId)) .'\'',
                    'class' => 'add',
                ),
                'position' => -70
            );            
        ...
        Mage::dispatchEvent('inventoryplus_warehouse_stock_action_buttons', 
                            array('stock_actions_object' => $stockActionsObject, 'warehouse' => $warehouse)
        );
...
//                }
            ...
            function addRequestStock(){
                ...
                var url = '" . $this->getUrl('inventorywarehouseadmin/adminhtml_requeststock/new', array('warehouse_id' => $warehouseId)) . "';
            ...
            function addSendStock(){
                ...
                var url = '" . $this->getUrl('inventorywarehouseadmin/adminhtml_sendstock/new', array('warehouse_id' => $warehouseId)) . "';
                window.location.href = url;
            }

 ...
 */
class Magestore_Inventoryplus_Adminhtml_AdjuststockController extends Magestore_Inventoryplus_Controller_Action {
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            try {
                ...
                if (!isset($data['adjuststock_products']) || empty($data['adjuststock_products'])) {
                    ...
                    if (!$this->getRequest()->getParam('id')) {
                        return $this->_redirect('inventoryplusadmin/adminhtml_adjuststock/new');

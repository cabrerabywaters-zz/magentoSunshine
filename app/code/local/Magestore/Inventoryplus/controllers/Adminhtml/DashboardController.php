 ...
 */
class Magestore_Inventoryplus_Adminhtml_DashboardController extends Magestore_Inventoryplus_Controller_Action {
        ...
        if ($check == 0) {
            ...
            try {
                ...
                if (Mage::helper('inventoryplus')->isWebPOS20Active()) {
                    Mage::helper('inventoryplus/install')->convertWebposLocationToWarehouse();
                }

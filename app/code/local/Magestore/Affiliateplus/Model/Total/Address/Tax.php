...
class Magestore_Affiliateplus_Model_Total_Address_Tax extends Mage_Tax_Model_Sales_Total_Quote_Tax {
     ...
     */
    protected function _calculateShippingTax(Mage_Sales_Model_Quote_Address $address, $rate, $appliedRates, $taxId = null) {
        ...
        parent::_calculateShippingTax($address, $rate, $appliedRates, $taxId);

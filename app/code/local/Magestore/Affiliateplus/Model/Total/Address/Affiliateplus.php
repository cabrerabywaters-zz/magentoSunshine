...
class Magestore_Affiliateplus_Model_Total_Address_Affiliateplus extends Mage_Sales_Model_Quote_Address_Total_Abstract {
    ...
    public function collect(Mage_Sales_Model_Quote_Address $address) {
		...
		$numberOrder = Mage::helper('affiliateplus/cookie')->getNumberOrdered();
        ...
        $discountObj = new Varien_Object(array(
            ...
            'program' => '',
			'base_discount_excl_tax' => '',/* Changed By Adam: 26/08/2015: Fix issue calculate grandtotal after using affiliate discount when calculate discount include tax and calculate tax after discount  */
        ));
        if (!isset($customerId))
            $customerId = '';

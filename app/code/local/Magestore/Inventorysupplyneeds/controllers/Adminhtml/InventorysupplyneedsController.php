 ...
 */
class Magestore_Inventorysupplyneeds_Adminhtml_InventorysupplyneedsController extends Magestore_Inventoryplus_Controller_Action {
    ...
    public function indexAction() {
        if (!$this->_hasSupplier()) {
            ...
            return $this->_redirect('inventorypurchasingadmin/adminhtml_supplier/new');
        }
    ...
    public function submitpoAction() {
        ...
        try {
            ...
            $this->_redirect('inventorypurchasingadmin/adminhtml_purchaseorders');
        } catch (Exception $e) {
            $model->rollBackPO();

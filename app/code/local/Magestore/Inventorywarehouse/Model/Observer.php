...
class Magestore_Inventorywarehouse_Model_Observer {
    ...
    public function addTabStore($observer) {
        ...
        $tab->addTab('store_section', array(
            ...
            'content' => $tab->getLayout()
                    ->createBlock('inventorywarehouse/adminhtml_warehouse_edit_tab_store', 'adminhtml_warehouse_edit_tab_store')
                    ->toHtml()
        ));
    }
...
//                        ->setUpdatedAt(now())
    ...
    public function inventoryplus_inventory_stock_action_buttons($observer) {
        ...
        /*
          ...
          'onclick' => 'location.href=\''.Mage::getSingleton('adminhtml/url')->getUrl('inventorywarehouseadmin/adminhtml_requeststock/new').'\'',
          'class' => 'save',
          ),
          'position' => -100
          );
        ...
        $actions['send_stock'] = array('params' => array(
                ...
                'onclick' => 'location.href=\'' . Mage::getSingleton('adminhtml/url')->getUrl('inventorywarehouseadmin/adminhtml_sendstock/new') . '\'',
                'class' => 'add',
            ),
            'position' => -200
        );
    ...
    public function inventoryplus_warehouse_stock_action_buttons($observer) {
        ...
        $stockActions['requeststock'] = array('params' => array(
                ...
                'onclick' => 'location.href=\'' . Mage::getSingleton('adminhtml/url')->getUrl('inventorywarehouseadmin/adminhtml_requeststock/new', array('warehouse_id' => $warehouse->getId())) . '\'',
                'class' => 'add',
            ),
            'position' => -92,
        );
        ...
        $stockActions['sendstock'] = array('params' => array(
                ...
                'onclick' => 'location.href=\'' . Mage::getSingleton('adminhtml/url')->getUrl('inventorywarehouseadmin/adminhtml_sendstock/new', array('warehouse_id' => $warehouse->getId())) . '\'',
                'class' => 'save',
            ),
            'position' => -91,
        );
     ...
     * @throws Exception
     */
    public function saveStoresInWarehouse($observer)
    {

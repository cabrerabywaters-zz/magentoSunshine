...
class Magestore_Inventorypurchasing_Model_Observer {
    ...
    public function inventorypurchasingMenu($observer) {
        ...
        $menu['supplier'] = array('label' => Mage::helper('inventorypurchasing')->__('Suppliers'),
            ...
            'level' => 0,
            'children' => array(
                'nosupplierproduct' => array('label' => Mage::helper('inventorypurchasing')->__('No Supplier Products'),
                    'sort_order' => 100,
                    'url' => Mage::helper("adminhtml")->getUrl("inventorypurchasingadmin/adminhtml_supplier/noSupplyProduct", array("_secure" => Mage::app()->getStore()->isCurrentlySecure())),
                    ...
                    'level' => 1),
                'managesupplier' => array('label' => Mage::helper('inventorypurchasing')->__('Manage Supplier'),
                    'sort_order' => 100,
        ...
        $menu['purchasing'] = array('label' => Mage::helper('inventorypurchasing')->__('Purchase / Receive Stock'),
            'sort_order' => 500,
            'url' => '',
    ...
    public function inventoryplus_inventory_stock_action_buttons($observer) {
        ...
        $actions['purchase_stock'] = array('params' => array(
                    ...
                    'onclick' => 'location.href=\''.Mage::getSingleton('adminhtml/url')->getUrl('inventorypurchasingadmin/adminhtml_purchaseorders/new').'\'',
                    'class' => 'add',
                        ),
                    'position' => -300
            );
    ...
    public function inventoryplus_warehouse_stock_action_buttons($observer) {
        ...
        $actions['purchase_stock'] = array('params' => array(
                    'label' => Mage::helper('inventorypurchasing')->__('Purchase Stock'),
                    'onclick' => 'location.href=\''.Mage::getSingleton('adminhtml/url')->getUrl('inventorypurchasingadmin/adminhtml_purchaseorders/new',array('warehouse_ids'=>$warehouse->getId())).'\'',
                    'class' => 'add',
                        ),
                    'position' => -95
            );

...
if(Mage::helper('core')->isModuleEnabled('Aitoc_Aitcheckoutfields')){
    class Aitoc_Aitemails_Model_Rewrite_CoreEmailTemplate_Aittmp extends Aitoc_Aitcheckoutfields_Model_Rewrite_CoreEmailTemplate {} 
 }else{
    /* default extends start */
    class Aitoc_Aitemails_Model_Rewrite_CoreEmailTemplate_Aittmp extends Mage_Core_Model_Email_Template {}
    /* default extends end */
}

/* AITOC static rewrite inserts end */
class Aitoc_Aitemails_Model_Rewrite_CoreEmailTemplate extends Aitoc_Aitemails_Model_Rewrite_CoreEmailTemplate_Aittmp
{

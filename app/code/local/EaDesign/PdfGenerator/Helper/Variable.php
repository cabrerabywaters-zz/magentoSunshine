...
class EaDesign_PdfGenerator_Helper_Variable extends Mage_Core_Helper_Abstract
{
    ...
    public function getTaxVariables()
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $variables[] = array(
            'value' => '{{var custom_invoice_perception}}',
            'label' => Mage::helper('pdfgenerator')->__('PE-Percepcion'),
        );
        $variables[] = array(
            'value' => '{{var custom_invoice_igv}}',
            'label' => Mage::helper('pdfgenerator')->__('PE-IGV'),
        );

         $variables[] = array(
            'value' => '{{var subtotal_Plus_IGV}}',
